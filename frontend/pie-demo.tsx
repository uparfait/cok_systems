// Temporary demo: exact copy of StatusPie3D from OverviewPage.tsx with sample data (40/40/20 like the reference image)
...
createRoot(document.getElementById('root')!).render(
  <div style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: 8, padding: 20, maxWidth: 620 }}>
    <div style={{ fontWeight: 700, fontSize: 15, marginBottom: 8 }}>Employee account status (demo · 8 / 8 / 4)</div>
    <StatusPie3D slices={[
      { label: 'Activated', value: 8, color: '#34A8DB' },
      { label: 'Not activated', value: 8, color: '#F39C12' },
      { label: 'Locked', value: 4, color: '#E53935' },
    ]} />
  </div>
);
