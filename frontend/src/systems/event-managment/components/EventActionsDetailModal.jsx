import { FiX, FiEye, FiSlash, FiActivity, FiPaperclip, FiFileText, FiDownload } from 'react-icons/fi';
      ...
      <div className="bg-white shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden" style={{ borderRadius: 0 }}>
        ...
        <div className="overflow-y-auto flex-1 px-6 py-5 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-3" style={{ backgroundColor: NEUTRAL_LIGHT }}>
              <p className="text-xs font-semibold text-zinc-500 uppercase tracking-wide mb-2 flex items-center gap-1" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                <span style={{ fontSize: '12px' }}>👤</span> Assigned To
              </p>
            ...
            <div className="p-3" style={{ backgroundColor: NEUTRAL_LIGHT }}>
              <p className="text-xs font-semibold text-zinc-500 uppercase tracking-wide mb-2 flex items-center gap-1" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                <span style={{ fontSize: '12px' }}>📅</span> Due Date
              </p>
        ...
        {/* footer */}
        <div className="px-6 py-3 border-t shrink-0 flex justify-between items-center" style={{ borderColor: '#E0E0E0' }}>
          {detailAction.currentStatus?.status !== 'Cancelled' && (
            <button
              onClick={() => { setDetailAction(null); openCancel(detailAction); }}
              className="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-semibold text-white rounded-none transition-colors"
          ...
          <button onClick={() => setDetailAction(null)} className="ml-auto px-4 py-2 text-sm font-medium border transition-colors" style={{ borderColor: '#E0E0E0', color: '#666666' }}>
            Close
          </button>
        </div>
      </div>
