...
const FIELD_TYPE_DOCS = {
  ...
  file: {
    ...
    extra_properties: { file_url: "Data URL or hosted URL of the file.", file_name: "Display name of the file." },
    usage_notes: "Different from 'file_upload': this is content the FORM shows, not an answer the respondent submits.",
  ...
  image_block: {
    ...
    extra_properties: { image_url: "Data URL or hosted URL of the image.", width_px: "Pixel width of the image (20-2000).", offset_px: "Pixel offset from the left edge." },
    usage_notes: "Different from 'image': this is content the FORM shows, not an answer the respondent submits.",
    example: { id: "image_block_ab12cd", type: "image_block", image_url: "", width_px: 200, offset_px: 0, design: { spacing_below_px: 16 } },
  },
  horizontal_line: {
  ...
  image: {
    description: "Respondent captures or uploads a photo, embedded as a base64 data URL in the submission.",
    extra_properties: { max_size_mb: "Number or null - rejects files larger than this many megabytes (null = unlimited).", accepted_types: "Array of accepted mime types, e.g. ['image/png','image/jpeg']." },
    usage_notes: "Applicable validation operators: max_file_size_mb, max_file_size_kb, max_file_size_gb, depends_on_parent.",
    example: { id: "image_ab12cd", type: "image", label: Object.assign({}, TRANSLATED_TEXT_EXAMPLE, { en: "Photo of the site" }), mandatory: false, max_size_mb: null, accepted_types: ["image/png", "image/jpeg"], validation_rules: [], design: { spacing_below_px: 16 } },
  },
  video: {
    description: "Respondent captures or uploads a video, embedded as a base64 data URL in the submission.",
    extra_properties: { max_size_mb: "Number or null - rejects files larger than this many megabytes (null = unlimited).", accepted_types: "Array of accepted mime types, e.g. ['video/mp4']." },
    usage_notes: "Applicable validation operators: max_file_size_mb, max_file_size_kb, max_file_size_gb, depends_on_parent.",
    example: { id: "video_ab12cd", type: "video", label: Object.assign({}, TRANSLATED_TEXT_EXAMPLE, { en: "Video walkthrough" }), mandatory: false, max_size_mb: null, accepted_types: ["video/mp4"], validation_rules: [], design: { spacing_below_px: 16 } },
  },
  audio: {
    description: "Respondent records or uploads audio, embedded as a base64 data URL in the submission.",
    extra_properties: { max_size_mb: "Number or null - rejects files larger than this many megabytes (null = unlimited).", accepted_types: "Array of accepted mime types, e.g. ['audio/mpeg']." },
    usage_notes: "Applicable validation operators: max_file_size_mb, max_file_size_kb, max_file_size_gb, depends_on_parent.",
    example: { id: "audio_ab12cd", type: "audio", label: Object.assign({}, TRANSLATED_TEXT_EXAMPLE, { en: "Voice note" }), mandatory: false, max_size_mb: null, accepted_types: ["audio/mpeg"], validation_rules: [], design: { spacing_below_px: 16 } },
  },
  file_upload: {
    description: "Respondent uploads any file (pdf, docx, spreadsheet, etc.), embedded as a base64 data URL in the submission.",
    extra_properties: { max_size_mb: "Number or null - rejects files larger than this many megabytes (null = unlimited).", accepted_types: "Array of accepted mime types, e.g. ['application/pdf']." },
    usage_notes: "Applicable validation operators: max_file_size_mb, max_file_size_kb, max_file_size_gb, depends_on_parent.",
    example: { id: "file_upload_ab12cd", type: "file_upload", label: Object.assign({}, TRANSLATED_TEXT_EXAMPLE, { en: "Supporting document" }), mandatory: false, max_size_mb: null, accepted_types: [], validation_rules: [], design: { spacing_below_px: 16 } },
  },
  signature: {
    description: "Respondent draws a signature, embedded as a base64 image data URL in the submission.",
    extra_properties: { max_size_mb: "Number or null.", accepted_types: "Usually left empty for signature." },
    usage_notes: "Applicable validation operators: max_file_size_mb, max_file_size_kb, max_file_size_gb, depends_on_parent.",
