...
const STAT_KEYS = [
  ...
  { valueKey: "DCS_HOME_ABOUT_STAT_2_VALUE", labelKey: "DCS_HOME_ABOUT_STAT_2_LABEL" },
...
export default function DcsHomeAbout() {
  ...
  return (
    <section className="relative bg-white flex items-center justify-center" style={{ minHeight: "70vh" }}>
      ...
      >
        <span
          className="text-xs font-semibold tracking-[0.3em] uppercase px-3 py-1"
          style={{ color: "#056daa", backgroundColor: "rgba(5,109,170,0.08)" }}
        >
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
          {STAT_KEYS.map((stat, index) => (
            ...
            >
              ...
              <span className="text-xs uppercase tracking-wide" style={{ color: "#555555", fontFamily: "'Montserrat', sans-serif" }}>
