...
const PROFILES = [
  ...
  { max: 300, height: 150, font: 9, value_font: 0, x_chars: 7, y_max: 84, bar: 14, column_bar: 18, row_base: 26, pie: "54%", side_legend: false, point_px: 26, cell_px: 44 },
  { max: 420, height: 180, font: 9, value_font: 9, x_chars: 9, y_max: 110, bar: 16, column_bar: 24, row_base: 28, pie: "58%", side_legend: false, point_px: 30, cell_px: 52 },
  { max: 600, height: 215, font: 10, value_font: 10, x_chars: 12, y_max: 150, bar: 20, column_bar: 32, row_base: 30, pie: "62%", side_legend: false, point_px: 36, cell_px: 60 },
  // Roomy (a medium or large card on a wide screen).
  { max: Infinity, height: 260, font: 11, value_font: 11, x_chars: 16, y_max: 240, bar: 22, column_bar: 40, row_base: 34, pie: "66%", side_legend: true, point_px: 44, cell_px: 72 },
];
