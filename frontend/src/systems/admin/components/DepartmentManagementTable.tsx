                    ...
                    return (
                      <tr key={`${dept._id}-${isSubDept ? "sub" : "parent"}`} className={`hover:bg-blue-50 transition-colors ${isSubDept ? "bg-purple-50/30" : ""}`}>
                        <td className="px-4 py-3"><div className={`flex items-center gap-2 ${isSubDept ? "ml-6" : ""}`}>
                          <div className={`w-8 h-8 flex items-center justify-center flex-shrink-0 ${isSubDept ? "bg-purple-100" : "bg-blue-100"}`}><HiOutlineOfficeBuilding className={`w-4 h-4 ${isSubDept ? "text-purple-600" : "text-blue-600"}`} /></div>
                        ...
                        <td className="px-4 py-3 text-center"><button onClick={() => handleShowEmployees(dept)} className="inline-flex items-center gap-1 px-2.5 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-700 text-sm font-semibold"><FiUsers className="w-3.5 h-3.5" />{deptEmployees.length}</button></td>
                        <td className="px-4 py-3 text-center"><button onClick={() => handleShowServices(dept)} className="inline-flex items-center gap-1 px-2.5 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-700 text-sm font-semibold"><FiPackage className="w-3.5 h-3.5" />{deptServices.length}</button></td>
                        ...
                        <td className="px-4 py-3"><div className="flex items-center gap-1">{!isSubDept && <button onClick={() => onAddUnit(dept)} className="p-1.5 text-white bg-blue-600 hover:bg-blue-700" title="Add Unit"><FiPlus className="w-3.5 h-3.5" /></button>}
                          <button onClick={() => onEdit(dept)} className="p-1.5 text-blue-600 hover:bg-blue-50" title="Edit"><FiEdit2 className="w-3.5 h-3.5" /></button>
