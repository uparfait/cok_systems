  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-2 sm:p-4">
      <div className="bg-white shadow-2xl w-full max-w-md mx-2 overflow-hidden border border-white/50">
        <div className="px-5 py-3.5 flex items-center justify-between  bg-blue-600">
        ...
        <div className="p-5 space-y-5">
          ...
          <div className="p-3 bg-gradient-to-r from-blue-50/50 to-indigo-50/50 border border-blue-100"><div className="flex justify-between items-center"><span className="text-xs font-medium text-gray-700">Regular Available Slots:</span><span className="text-base font-bold text-blue-600">{calculateRegularSlots()}</span></div></div>
        </div>
        <div className="px-5 py-3.5 border-t border-gray-100 bg-gray-50 flex gap-3">
          ...
          <button onClick={onSave} disabled={saving} className="flex-1 py-2.5 px-3 bg-gradient-to-r bg-blue-600 cursor-pointer  text-white text-sm font-medium hover:from-indigo-600 hover:to-blue-600 disabled:opacity-50 flex items-center justify-center gap-1.5">
