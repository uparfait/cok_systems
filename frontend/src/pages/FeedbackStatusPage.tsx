  ...
  return (
    <div className="max-w-6xl mx-auto px-3 sm:px-4 py-4 sm:py-6">
      ...
      <div className="mb-4 sm:mb-6">
        <h1 className="text-sm sm:text-base font-bold flex items-center gap-2" style={{ fontFamily: fontHeading, color: NEUTRAL_DARK }}>
          <FiMessageSquare className="w-4 h-4 sm:w-5 sm:h-5" style={{ color: PRIMARY }} />
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
          <div className="flex-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 focus:outline-none" style={inputStyle} onFocus={handleInputFocus} onBlur={handleInputBlur}
          ...
          <div className="flex items-end">
            <button
              ...
              className="w-full sm:w-auto px-4 py-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-1.5"
        ...
        <>
          ...
          {summary && (
            <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-3 sm:mb-4">
              <div className="bg-white border border-gray-200 p-2 sm:p-4">
                <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-wide" style={{ fontFamily: fontHeading, color: TERTIARY }}>Total</p>
                <p className="text-lg sm:text-2xl font-bold" style={{ fontFamily: fontHeading, color: NEUTRAL_DARK }}>{summary.total_assigned_departments}</p>
              </div>
              <div className="bg-white border border-gray-200 p-2 sm:p-4">
                <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-wide" style={{ fontFamily: fontHeading, color: TERTIARY }}>Completed</p>
                <p className="text-lg sm:text-2xl font-bold" style={{ fontFamily: fontHeading, color: '#4CAF50' }}>{summary.completed_feedback}</p>
              </div>
              <div className="bg-white border border-gray-200 p-2 sm:p-4">
                <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-wide" style={{ fontFamily: fontHeading, color: TERTIARY }}>Pending</p>
                <p className="text-lg sm:text-2xl font-bold" style={{ fontFamily: fontHeading, color: '#F39C12' }}>{summary.pending_feedback}</p>
              </div>
            </div>
          )}
          ...
          <div className="bg-white border border-gray-200 overflow-hidden">
            ...
            <div className="px-3 sm:px-4 py-2.5 sm:py-3 border-b border-gray-200 bg-gray-50">
              <h2 className="text-xs sm:text-sm font-bold" style={{ fontFamily: fontHeading, color: NEUTRAL_DARK }}>Service Records</h2>
              ...
              <table className="w-full min-w-[600px]">
                <thead>
                  <tr className="bg-gray-50">
                    <th className="px-2 sm:px-4 py-2 sm:py-2.5 text-left text-[10px] sm:text-xs font-semibold uppercase tracking-wider" style={{ fontFamily: fontHeading, color: TERTIARY }}>#</th>
                    <th className="px-2 sm:px-4 py-2 sm:py-2.5 text-left text-[10px] sm:text-xs font-semibold uppercase tracking-wider" style={{ fontFamily: fontHeading, color: TERTIARY }}>Department</th>
                    ...
                    <th className="px-2 sm:px-4 py-2 sm:py-2.5 text-center text-[10px] sm:text-xs font-semibold uppercase tracking-wider" style={{ fontFamily: fontHeading, color: TERTIARY }}>Status</th>
                    <th className="px-2 sm:px-4 py-2 sm:py-2.5 text-center text-[10px] sm:text-xs font-semibold uppercase tracking-wider" style={{ fontFamily: fontHeading, color: TERTIARY }}>Rating</th>
                    ...
                    <th className="px-2 sm:px-4 py-2 sm:py-2.5 text-center text-[10px] sm:text-xs font-semibold uppercase tracking-wider" style={{ fontFamily: fontHeading, color: TERTIARY }}>Action</th>
                  </tr>
                </thead>
                    ...
                    <tr>
                      <td colSpan={8} className="px-4 py-6 text-center">
                        <div className="flex items-center justify-center gap-2 text-gray-500">
                          <span className="animate-spin rounded-full h-5 w-5 border-2 border-[#056daa] border-t-transparent" />
                      ...
                      return (
                        <tr key={dept.department_id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-2 sm:px-4 py-3">
                            <div>
                              <p className="text-xs sm:text-sm font-semibold" style={{ fontFamily: fontHeading, color: NEUTRAL_DARK }}>{dept.department_name}</p>
                          ...
                          <td className="px-2 sm:px-4 py-3 text-center">
                            {feedbackItem ? (
                              ...
                              <button
                                ...
                                className="inline-flex items-center gap-1 px-2 sm:px-2.5 py-1.5 sm:py-1.5 transition-colors"
                                style={{ ...buttonBaseStyle, fontSize: '11px', backgroundColor: PRIMARY, color: WHITE, border: 'none' }}
                                onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = PRIMARY_HOVER; }}
                                onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = PRIMARY; }}
                              >
      ...
      {!errorMessage && !isVerifying && !isLoadingFeedback && departments.length === 0 && feedback.length === 0 && (
        <div className="bg-white border border-gray-200 p-4 sm:p-6 text-center">
          ...
          <p className="text-xs sm:text-sm font-semibold mb-1" style={{ fontFamily: fontHeading, color: NEUTRAL_DARK }}>No Service History</p>
