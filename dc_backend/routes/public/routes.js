...
const { get_public_dashboard, get_public_dashboard_data, get_public_kpi_skipped, get_public_filter_values, get_public_widget_records, get_public_widget_records_export, get_public_map_shapes } = require("../../util-dashboard/controllers/public_dashboard.js");
...
/**
 * @swagger
 * /dcs/api/public/dashboard/{token}/map-shapes:
 *   post:
 *     summary: The boundary outlines a shared map widget draws, no auth
 *     tags: [Public]
 */
Router.post("/dashboard/:token/map-shapes", get_public_map_shapes);
