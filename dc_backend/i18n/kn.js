module.exports = {
  ...
  SUBMISSION_FETCHED: "Inyandiko yabonetse neza",
  SUBMISSION_UPDATED: "Inyandiko yavuguruwe neza",
  SUBMISSIONS_DELETED: "Inyandiko {{count}} zasibwe neza",
  TABLE_SETTINGS_FETCHED: "Igenamiterere ry'imbonerahamwe ryabonetse neza",
  TABLE_SETTINGS_SAVED: "Igenamiterere ry'imbonerahamwe ryabitswe neza",
  TRACKING_CONFIG_INVALID: "Igenamiterere ryo gukurikirana inyandiko ntiryemewe",
  TRACKING_NOT_ENABLED: "Iyi fishi ntikurikirana inyandiko",
  TRACKING_KEY_REQUIRED: "Andika agaciro k'urufunguzo ushaka gushakisha",
  TRACKING_KEY_EXISTS: "Inyandiko ifite iyi {{field}} isanzweho. Yishakishe hanyuma uyivugurure",
  TRACKING_RECORDS_FETCHED: "Inyandiko zabonetse neza",
  TRACKING_NO_CHANGES: "Nta kintu cyahinduwe ku myanya ishobora kuvugururwa",
  TRACKING_RECORD_UPDATED: "Inyandiko yavuguruwe neza",
  ...
  DATA_TOKENS_FETCHED: "Impushya zo kugera ku makuru zabonetse",
  DATA_TOKEN_CREATED: "Uruhushya rwo kugera ku makuru rwakozwe",
  DATA_TOKEN_ROTATED: "Uruhushya rwavuguruwe - amalinki ya kera ntakora",
  DATA_TOKEN_DELETED: "Uruhushya rwakuweho",
  DATA_TOKEN_NOT_FOUND: "Uruhushya ntirubonetse",
  DATA_TOKEN_NAME_REQUIRED: "Ha uruhushya izina",
  DATA_TOKEN_EXPIRY_INVALID: "Itariki yo kurangira igomba kuba mu gihe kizaza",
  DATA_TOKEN_INVALID: "Uru ruhushya rwo kugera ku makuru ntirwemewe",
  DATA_TOKEN_EXPIRED: "Uru ruhushya rwo kugera ku makuru rwarangiye",
  DATA_FEED_FETCHED: "Imiterere y’amakuru yabonetse",
  EXPORT_STARTED: "Kohereza hanze byatangiye",
  EXPORT_JOB_FETCHED: "Aho kohereza hanze bigeze byabonetse",
