...
/**
 * The scheduling dialog's whole state for one form: the approvers the
 * form's own approval flow settings define (read-only here - the dialog
 * only sets the timer), the schedule still waiting to fire (if any) and
 * the recent batches already sent.
 */
