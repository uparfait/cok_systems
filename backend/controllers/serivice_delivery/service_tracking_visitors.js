...
module.exports = async function service_tracking_visitors(req, res, next) {
  try {
    ...
    console.error("Error in service_tracking_visitors:", error);
    return res.status(500).json({
      success: false,
      type: "error",
      message: "Something went wrong while retrieving service tracking visitors",
      error: error.message,
    });
  }
};
